...
export const STRINGS = {
  ...
  "detail.modelVerdict": { en: "Model's official call", zh: "模型基准判断" },
  "detail.sandboxTitle": { en: "What-if sandbox", zh: "自定义推演" },
  "detail.sandboxNote": { en: "tune the factors below to see how the probabilities move — this is your scenario, not the official call", zh: "拖动下方因子看概率如何变化;这是你的假设,模型基准判断见上方" },
